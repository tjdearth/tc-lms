...
const SIGNATURE_TEMPLATES: Record<string, SignatureTemplate> = {
  ...
  "Travel Collection": {
    ...
    render: (v) => {
      ...
      return `<table style="font-family:Arial,sans-serif;font-size:14px;color:#2a2a2a;line-height:1.6"><tr><td style="padding-right:18px"><img src="https://atlas.travelcollection.co/logos/tc.png" style="max-height:100px;border-radius:8px;display:block"></td><td style="border-left:3px solid #3f5062;padding:4px 0 4px 18px"><b style="font-size:17px;color:#3f5062">${v.name || "Full Name"}</b><div style="font-size:12px;color:#888;text-transform:uppercase;margin-bottom:10px">${v.title || "Job Title"}</div><table><tr><td style="padding-right:8px"><img src="https://atlas.travelcollection.co/social/phone.png" style="width:14px;height:14px"></td><td><a href="tel:${telHref}" style="text-decoration:none;color:#2a2a2a">${v.phone || "+000 000 000 000"}</a></td></tr><tr><td style="padding-right:8px"><img src="https://atlas.travelcollection.co/social/email.png" style="width:14px;height:14px"></td><td><a href="mailto:${v.email || "email@travelcollection.co"}" style="text-decoration:none;color:#2a2a2a">${v.email || "email@travelcollection.co"}</a></td></tr><tr><td style="padding-right:8px"><img src="https://atlas.travelcollection.co/social/domain.png" style="width:14px;height:14px"></td><td><a href="https://travelcollection.co" target="_blank" style="text-decoration:none;color:#3f5062;font-weight:500">travelcollection.co</a></td></tr></table></td></tr></table>`;
    },
  },
  "Kembali Asia": {
    name: "Kembali Asia",
