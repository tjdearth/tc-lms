...
const SIGNATURE_TEMPLATES: Record<string, SignatureTemplate> = {
  ...
  "Travel Collection": {
    ...
    render: (v) => {
      ...
      return `<table style="font-family:Arial,sans-serif;font-size:14px;color:#2a2a2a;line-height:1.6;white-space:nowrap"><tr><td style="padding-right:18px"><img src="https://atlas.travelcollection.co/logos/tc.png" style="max-height:100px;border-radius:8px;display:block"></td><td style="border-left:3px solid #3f5062;padding:4px 0 4px 18px"><b style="font-size:17px;color:#3f5062">${v.name || "Full Name"}</b><div style="font-size:12px;color:#888;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:10px">${v.title || "Job Title"}</div><div><img src="https://atlas.travelcollection.co/social/phone.png" style="width:14px;height:14px;vertical-align:middle;margin-right:8px"><a href="tel:${telHref}" style="text-decoration:none;color:#2a2a2a">${v.phone || "+000 000 000 000"}</a></div><div><img src="https://atlas.travelcollection.co/social/email.png" style="width:14px;height:14px;vertical-align:middle;margin-right:8px"><a href="mailto:${v.email || "email@travelcollection.co"}" style="text-decoration:none;color:#2a2a2a">${v.email || "email@travelcollection.co"}</a></div><div><img src="https://atlas.travelcollection.co/social/domain.png" style="width:14px;height:14px;vertical-align:middle;margin-right:8px"><a href="https://travelcollection.co" style="text-decoration:none;color:#3f5062;font-weight:500">travelcollection.co</a></div></td></tr></table>`;
    },
  },
  "Kembali Asia": {
    name: "Kembali Asia",
