...
const SIGNATURE_TEMPLATES: Record<string, SignatureTemplate> = {
  ...
  "Experience Morocco": {
    ...
    render: (v) => {
      ...
      return `<table style="background:#a34e2f;font-family:Montserrat,Arial,sans-serif;color:#fff"><tr><td style="padding:0 20px"><img src="https://atlas.travelcollection.co/logos/experience-morocco.png" width="180"></td><td style="padding:20px 16px 20px 0;font-size:13px;line-height:1.6;white-space:nowrap"><b style="font-size:15px">${v.name || "Full Name"}</b><div style="font-size:12px;margin-bottom:10px">${v.title || "Job Title"}</div><div><b>Email:</b> <a href="mailto:${v.email || "email@experiencemorocco.com"}" style="color:#fff">${v.email || "email@experiencemorocco.com"}</a></div><div><b>Website:</b> <a href="https://experiencemorocco.com" style="color:#fff">www.experiencemorocco.com</a></div><div><b>Phone:</b> <a href="tel:${telHref}" style="color:#fff">${v.phone || "+000 0 00 000 000"}</a></div></td><td style="padding-right:20px;vertical-align:middle"><a href="https://linkedin.com/company/experience-morocco"><img width="18" height="18" src="https://atlas.travelcollection.co/social/li.png" style="display:block;margin-bottom:8px"></a><a href="https://facebook.com/expmorocco"><img width="18" height="18" src="https://atlas.travelcollection.co/social/fb.png" style="display:block;margin-bottom:8px"></a><a href="https://instagram.com/experiencemorocco"><img width="18" height="18" src="https://atlas.travelcollection.co/social/ig.png" style="display:block"></a></td></tr></table>`;
    },
  },
