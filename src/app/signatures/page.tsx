...
const SIGNATURE_TEMPLATES: Record<string, SignatureTemplate> = {
  ...
  <p style="margin:0"><img src="https://atlas.travelcollection.co/logos/sar-turkiye-email.png" width="96" alt="SAR Turkiye"></p>
  ...
  <td style="border-right:1px solid #000;padding-right:10px;vertical-align:middle">
    <img src="https://atlas.travelcollection.co/logos/awaken-peru-email.png" width="200" alt="Awaken Peru">
  </td>
  <td style="padding-left:10px;vertical-align:middle">
    ...
    <div style="margin-top:4px;white-space:nowrap">
      <a href="http://www.awakenperu.com" target="_blank"><img src="https://atlas.travelcollection.co/social/website.png" width="24" height="24" alt="website" style="border:0;display:inline"></a>&nbsp;
      <a href="https://www.linkedin.com/company/awaken-peru/" target="_blank"><img src="https://atlas.travelcollection.co/social/linkedin-dark.png" width="24" height="24" alt="linkedin" style="border:0;display:inline"></a>&nbsp;
      <a href="https://www.instagram.com/awaken_peru/" target="_blank"><img src="https://atlas.travelcollection.co/social/instagram-dark.png" width="24" height="24" alt="instagram" style="border:0;display:inline"></a>
    </div>
  </td>
</tr></table>`,
  },
  ...
  "Essentially French": {
    ...
    render: (v) => `<table width="600" style="background:#442620;font-family:Montserrat,Arial,sans-serif;color:#fff;font-weight:200"><tr style="height:95px"><td style="padding:0 30px"><img src="https://atlas.travelcollection.co/logos/essentially-french-email.png" width="140" style="display:block"></td><td style="border-left:1px solid #fff;padding-left:30px;font-size:11px;line-height:13px"><div style="font-weight:300;font-size:17px;line-height:18px;letter-spacing:3px;text-transform:uppercase;white-space:nowrap">${v.name || "Full Name"}</div><div style="letter-spacing:2px;text-transform:uppercase;padding-top:6px">${v.title || "Job Title"}</div><div style="padding-top:8px">${v.phone || "+00 000 000 000"}<br><a href="mailto:${v.email || "email@essentiallyfrench.com"}" style="color:#fff;text-decoration:none">${v.email || "email@essentiallyfrench.com"}</a><br><a href="https://essentiallyfrench.com" style="color:#fff;text-decoration:none">www.essentiallyfrench.com</a></div></td><td align="right" style="padding-right:30px"><a href="https://instagram.com/essentiallyfrenchtravel"><img src="https://atlas.travelcollection.co/social/ig.png" width="18" height="18" style="display:block;margin:0 0 6px auto"></a><a href="https://linkedin.com/company/106258477"><img src="https://atlas.travelcollection.co/social/li.png" width="18" height="18" style="margin-left:auto"></a></td></tr></table>`,
  },
  "Oshinobi Travel": {
  ...
  "Travel Collection": {
    ...
    fields: [
      { key: "name", label: "Full Name", placeholder: "e.g. Ihab EL ALAMI" },
      { key: "title", label: "Job Title", placeholder: "e.g. Chief Technology Officer" },
      { key: "phone", label: "Phone", placeholder: "e.g. +212 646 494 979" },
      { key: "email", label: "Email Address", placeholder: "e.g. ihab@travelcollection.co" },
    ],
    render: (v) => {
      const telHref = (v.phone || "").replace(/\s/g, "");
      return `<table style="font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Arial,sans-serif;font-size:14px;color:#2a2a2a;line-height:1.6;border-collapse:collapse"><tr><td style="padding-right:18px;vertical-align:middle"><img src="https://atlas.travelcollection.co/logos/tc.png" alt="Travel Collection" style="max-height:100px;border-radius:8px;display:block"></td><td style="border-left:3px solid #3f5062;padding:4px 0 4px 18px;vertical-align:middle"><div style="font-size:17px;font-weight:600;color:#3f5062;letter-spacing:.2px">${v.name || "Full Name"}</div><div style="font-size:12px;color:#888;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:10px">${v.title || "Job Title"}</div><div><img src="https://atlas.travelcollection.co/social/phone.png" width="14" height="14" style="vertical-align:middle;margin-right:8px"><a href="tel:${telHref}" style="text-decoration:none;color:#2a2a2a">${v.phone || "+000 000 000 000"}</a></div><div><img src="https://atlas.travelcollection.co/social/email.png" width="14" height="14" style="vertical-align:middle;margin-right:8px"><a href="mailto:${v.email || "email@travelcollection.co"}" style="text-decoration:none;color:#2a2a2a">${v.email || "email@travelcollection.co"}</a></div><div><img src="https://atlas.travelcollection.co/social/domain.png" width="14" height="14" style="vertical-align:middle;margin-right:8px"><a href="https://www.travelcollection.co" style="text-decoration:none;color:#3f5062;font-weight:500">travelcollection.co</a></div></td></tr></table>`;
    },
  },
  "Kembali Asia": {
    name: "Kembali Asia",
  ...
  "Experience Morocco": {
    ...
    render: (v) => `<table style="background:#a34e2f;font-family:Montserrat,Arial,sans-serif;color:#fff"><tr><td style="padding:0 20px"><img src="https://atlas.travelcollection.co/logos/experience-morocco.png" width="180"></td><td style="padding:20px 16px 20px 0;font-size:13px;line-height:1.6;white-space:nowrap"><b style="font-size:15px">${v.name || "Full Name"}</b><div style="font-size:12px;margin-bottom:10px">${v.title || "Job Title"}</div><div><b>Email:</b> <a href="mailto:${v.email || "email@experiencemorocco.com"}" style="color:#fff">${v.email || "email@experiencemorocco.com"}</a></div><div><b>Website:</b> <a href="https://experiencemorocco.com" style="color:#fff">www.experiencemorocco.com</a></div><div><b>Phone:</b> <a href="tel:${(v.phone||"").replace(/\s/g,"")}" style="color:#fff">${v.phone || "+000 0 00 000 000"}</a></div></td><td style="padding-right:20px;vertical-align:middle"><a href="https://linkedin.com/company/experience-morocco"><img width="18" height="18" src="https://atlas.travelcollection.co/social/li.png" style="display:block;margin-bottom:8px"></a><a href="https://facebook.com/expmorocco"><img width="18" height="18" src="https://atlas.travelcollection.co/social/fb.png" style="display:block;margin-bottom:8px"></a><a href="https://instagram.com/experiencemorocco"><img width="18" height="18" src="https://atlas.travelcollection.co/social/ig.png"></a></td></tr></table>`,
  },
